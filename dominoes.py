...
def dots(var):
    number = int(var)
    current_dots=int(number*(number+1)+(number*(number+1))/2)
    #print(current_dots)
    return (current_dots)
...
def dots_on_domino_bones(n):
    ...
    if n < 0:
        ...
        while count <= n:
            total_dot_count = total_dot_count + dots(count)
            count = count +1
        return (total_dot_count)
    


"""print(dots_on_domino_bones(2))
print(dots_on_domino_bones(3))
print(dots_on_domino_bones(20))
print(dots_on_domino_bones(-3))"""